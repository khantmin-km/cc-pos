        ...
        <div class="chart-stats">
          <div class="stat">
            ...
            <span class="stat-value">
              ${{ salesData.length > 0 ? (salesData.reduce((sum, d) => sum + d.sales, 0) / salesData.length / 1000).toFixed(1) : '0.0' }}k
            </span>
          </div>
          <div class="stat">
            <span class="stat-label">Total:</span>
            <span class="stat-value">
              ${{ salesData.length > 0 ? (salesData.reduce((sum, d) => sum + d.sales, 0) / 1000).toFixed(1) : '0.0' }}k
            </span>
          </div>
        </div>
      </div>
